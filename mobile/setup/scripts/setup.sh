...
wp core install --url=http://mobile.usc.edu --title=USC_Gateway_for_Mobile --admin_user=dcorley --admin_email=dcorley@usc.edu --admin_password=${USC_MOBILE_ADMIN_PASSWORD}
